...
type TabKey = "overview" | "processes" | "events" | "software" | "printers" | "licenses" | "startup" | "services" | "system" | "actions";
...
export default function ComputerDetailPage() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const pollInterval = setInterval(async () => {
          ...
          const cmd = cmds.find((c: { id: string; status: string; result: string | null }) => c.id === commandId);
  ...
  const renderTab = () => {
    switch (tab) {
      case "overview": return <OverviewTab computer={computer} />;
      case "processes": return <ProcessesTab report={report} />;
      case "events": return <EventsTab report={report} />;
      case "software": return <SoftwareTab report={report} />;
      case "printers": return <PrintersTab report={report} />;
      case "licenses": return <LicensesTab report={report} />;
      case "startup": return <StartupTab report={report} />;
      case "services": return <ServicesTab report={report} sendCommand={sendCommand} actionLoading={actionLoading} />;
      case "system": return <SystemTab report={report} />;
      case "actions": return <ActionsTab computer={computer} />;
      default: return null;
    }
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={() => {
              window.open(`/api/computers/${computer.id}/export`, "_blank");
            }}
