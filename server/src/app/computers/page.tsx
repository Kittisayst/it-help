...
export default function ComputersPage() {
    ...
    useEffect(() => {
        setPage(1);
    }, [search, filterDepartment, filterGroup]);

    const computers: ComputerItem[] = data?.data || [];
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    <button
                        onClick={() =>
                            window.open(
                                `/api/computers/export?status=${filterStatus}`,
                                "_blank",
                            )
                        }
                        ...
                        >
                            ...
                            {computer.lastReport ? (
                                <div className="space-y-3">
                                    <UsageBar
                                        label="CPU"
                                        value={computer.lastReport.cpuUsage}
                                    />
                                    <UsageBar
                                        label="RAM"
                                        value={computer.lastReport.ramUsage}
                                    />
                                    <UsageBar
                                        label="Disk"
                                        value={computer.lastReport.diskUsage}
                                    />
                                </div>
                            ) : (
