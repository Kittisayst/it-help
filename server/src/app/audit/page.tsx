    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted text-sm mt-1">Admin actions and system events</p>
        </div>
      </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {log.userId && (
                      <span className="text-xs text-muted">by User ID: {log.userId}</span>
                    )}
                    {log.computerId && (
                      <span className="text-xs text-muted">on Computer ID: {log.computerId}</span>
                    )}
                  </div>
                  {log.details && (
